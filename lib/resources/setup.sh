...
# ec2-userにacme.shインストール
su - ec2-user -c curl "https://get.acme.sh | sh"

# パブリックIP取得
PUBLIC_IP=$(curl -s http://checkip.amazonaws.com)

# IPアドレス証明書発行
ACME_DIR="/home/ec2-user/.acme.sh"
...
# 権限をrootからec2-userに変更
chown -R ec2-user:ec2-user /home/ec2-user/openwebui/nginx/ssl
chown -R ec2-user:ec2-user /home/ec2-user/.acme.sh
